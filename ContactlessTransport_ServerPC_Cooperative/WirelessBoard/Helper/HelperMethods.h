...
static std::complex<float> propagateFieldToPoint(float point[3], std::complex<float>* singlePointField, const float* transducerPositions, int numTransducers, float P0=8.02f) {
	float Re = 0, Im = 0;
...
static std::complex<float> propagateFieldToPoint(float point[3], std::complex<float>* singlePointField, int boardSize[2], float pitch) {
...
static std::complex<float> propagateFieldToPointFromPhases(float point[3], float* singlePointField_Phases, int boardSize[2], float pitch) {
	int w = boardSize[0], h = boardSize[1];
	float Re = 0, Im = 0;
	for (int i = 0; i < w; i++) {
		for (int j = 0; j < h; j++) {
