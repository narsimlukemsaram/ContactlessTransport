#define NUM_TRANSDUCERS_PER_GROUP 64 //TODO: Make this an argument.
...
__kernel void discretise(int numDiscreteLevels,
	...
	unsigned char PIN_index = transducerNumberToPIN_ID[x] % NUM_TRANSDUCERS_PER_GROUP;//PIN index in its local board (256 elements)
	...
	int groupNumber = x/NUM_TRANSDUCERS_PER_GROUP; 
